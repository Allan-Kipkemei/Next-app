...
const LeftSection = () => {
    ...
    const allChats = [
        {
            id: 1,
            chatName: 'A fascinating conversation about technology!'
        },
        {
            id: 2,
            chatName: 'Exploring the wonders of science together.'
        },
        {
            id: 3,
            chatName: 'Movie enthusiasts gather for an exciting chat.'
        },
        {
            id: 4,
            chatName: 'Dive into the world of literature.'
        },
        {
            id: 5,
            chatName: 'Discover new places and cultures.'
        }
    ];
    return (
        <div className={styles.leftSection}>
            ...
            <div className={styles.newChat}>
                <div>
                    ...
                    <p className={styles.text1}>Allan Kiplagat</p>
                </div>
